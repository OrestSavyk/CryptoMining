...
export const INNER_CAROUSEL = [
    ...
    },    
    {
        ...
        lowerText: 'The Shop app was designed to provide the best collection of miners available.',
    ...
    },    
    {
        ...
        lowerText: 'Compare all the SHA256 miners to make the best choice for your needs.',
    ...
    },    
    {
        ...
        lowerText: 'The mining directory is a comprehensive list of hosting facilities worldwide. Choose your preffered hosting type, compare rates a quote real time.',
...
export const LINK_ITEM = [
    {
        ...
        paragraph: 'Shop online for the best prices on a variety of miners for sale in the marketplace. Buy with confidence, as our team is here to help you with every step of the purchase process making sure you have a smooth transaction.'
    },
    {
        id: 1,
        orderImg: 1,
        ...
        paragraph: 'Need hosting or power? Use our interactive hosting directory to find a hosting solution that is right for you. Our directory is one of a kind and the only miner hosting and power directory in existence. Another first from Crypto Mining Tools.'
    },
    {
        id: 2,
        orderImg: 2,
        ...
        paragraph: 'The best bitcoin mining calculator available. The only online tool for calculating profitability & Days to ROI that actually includes the impact of the bitcoin block reward halving.'
    },
    {
        id: 3,
        orderImg: 1,
